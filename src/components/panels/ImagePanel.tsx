              ...
              <div className="pb-2">
                ...
                <div className="mt-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2 py-1 rounded text-xs bg-editor-elevated-highlight text-[#f2f2f2] hover:text-editor-text border border-editor-border transition-colors"
                  >
                    <RotateCcw size={10} />
                    Reset Adjustments
                  </button>
